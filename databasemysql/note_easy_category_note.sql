...
CREATE TABLE `category_note` (
  `id_category_note` int NOT NULL AUTO_INCREMENT,
  `category_type` varchar(50) NOT NULL,
  PRIMARY KEY (`id_category_note`)
...
INSERT INTO `category_note` VALUES (1,'Favorites'),(2,'Important'),(3,'Personal'),(4,'Story'),(5,'funny'),(6,'garbage');
